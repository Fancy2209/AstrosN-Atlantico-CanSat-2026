...
class GPS:
    ...
    def write(self, bytestr: AnyReadableBuf) -> Optional[int]:
    ...
    def _update_timestamp_utc(self, time_utc: str, date: Optional[str] = None) -> None:
        ...
        self.timestamp_utc = [year, month, day, hours, mins, secs]
...
class GPS_GtopI2C(GPS):
    ...
    def write(self, bytestr: AnyReadableBuf) -> None:
        """Write a bytestring data to the GPS directly, without parsing
        or checksums"""
        with self._i2c as i2c:
            i2c.write(bytestr)
